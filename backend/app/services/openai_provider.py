    ...
    async def initiate_call(
        ...
        if agent:
            ...
            call_setup_data = {
                ...
                "vad_threshold": agent.vad_threshold or 0.3,
                "turn_detection": agent.turn_detection or "semantic_vad",
                "vad_eagerness": agent.vad_eagerness or "high",
                "silence_duration_ms": agent.silence_duration_ms or 800,
                "prefix_padding_ms": agent.prefix_padding_ms or 200,
                "interrupt_response": True,  # FORCED True — non-negotiable system rule
